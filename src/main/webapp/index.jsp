...
<head>
  ...
  <script>
	...
	<input type="text" id="email-phone" name="emailPhone" style="width: 310px;" pattern="(\w+@\w+\.\w+)|(\d{9})|(\w+\.\w+@\w+\.\w+\.\w+)" required title="Ingrese un email válido o un número de celular válido (9 dígitos)">
