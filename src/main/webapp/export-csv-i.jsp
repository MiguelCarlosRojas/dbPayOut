...
<%
    ...
    try {
        ...
        String query = "SELECT names, last_name, type_document, number_document, email, cell_phone, career, semester, active FROM dbo.person WHERE active = 'I' ORDER BY names";
