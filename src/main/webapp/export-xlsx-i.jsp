...
<%
  ...
  try {
    ...
    // Obtener los datos de la tabla "person" que estén activos
    ...
    Sheet sheet = workbook.createSheet("Inactive Person Data");
    ...
    // Agregar los datos de la tabla "person" activos al libro de Excel
    int rowNum = 1;
    while (rs.next()) {
